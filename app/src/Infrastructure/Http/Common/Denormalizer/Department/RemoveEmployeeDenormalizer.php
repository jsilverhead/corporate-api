...
use App\Infrastructure\Http\Common\Dto\Department\RemoveEmployeeDto;
...
class RemoveEmployeeDenormalizer
{
    ...
    public function denormalize(Payload $payload): RemoveEmployeeDto
    {
        /**
         * @psalm-var array{
         *     employeeId: Uuid,
