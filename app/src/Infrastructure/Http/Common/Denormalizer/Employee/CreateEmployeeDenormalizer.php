...
use App\Infrastructure\Http\Common\Dto\Employee\CreateEmployeeDto;
...
readonly class CreateEmployeeDenormalizer
{
    ...
    public function denormalize(Payload $payload): CreateEmployeeDto
    {
        /**
         * @psalm-var array{
